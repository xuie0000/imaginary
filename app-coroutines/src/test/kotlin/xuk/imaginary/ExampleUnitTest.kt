...
//    }
  ...
  @Throws(Exception::class)
  fun gk_test() {
    val test = "{\"_id\":\"5ccdbc219d212239df927a93\",\"createdAt\":\"2019-05-04T16:21:53.523Z\",\"desc\":\"2019-05-05\",\"publishedAt\":\"2019-05-04T16:21:59.733Z\",\"source\":\"web\",\"type\":\"\\u798f\\u5229\",\"url\":\"http://ww1.sinaimg.cn/large/0065oQSqly1g2pquqlp0nj30n00yiq8u.jpg\",\"used\":true,\"who\":\"lijinshanmx\"}"
    println("gk_test:${Gson().fromJson(test, GkIo.BaseBean::class.java)}")
  }
  ...
  fun gk_category() {
    ...
    val adapter = RuntimeTypeAdapterFactory
        .of(GkIo.CategoryBean::class.java)
