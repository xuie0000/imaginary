...
object ServiceGenerator {
    ...
    private val mRewriteCacheControlInterceptor = Interceptor { chain ->
        ...
        if (!NetWorkUtils.isNetConnected(App.context)) {
            request = request.newBuilder()
                    .cacheControl(
                            if (TextUtils.isEmpty(cacheControl)) CacheControl.FORCE_NETWORK
    ...
    private fun <S> createService(serviceClass: Class<S>, builder: Retrofit.Builder, authToken: String?): S {
        //开启Log
