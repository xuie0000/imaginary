...
public final class MyAppGlideModule extends AppGlideModule {
    ...
    public void applyOptions(@NonNull Context context, GlideBuilder builder) {
        /*
         * 在 Android 中有两个主要的方法对图片进行解码：ARGB8888 和 RGB565(DecodeFormat.PREFER_RGB_565)。
         * 前者为每个像素使用了 4 个字节，后者仅为每个像素使用了 2 个字节。ARGB8888 的优势是图像质量更高以及能存储
         * 一个 alpha 通道。Picasso 使用 ARGB8888，Glide 默认使用低质量的 RGB565
         */
